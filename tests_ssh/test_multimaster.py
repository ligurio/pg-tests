...
class TestMultimaster():
    ...
    def teardown_cluster(self, nodes):
        """Return cluster config to initial state
        1. Return old postgresql.conf
        2. Return old pg_hba.conf
        3. Delete data for tests
        :return:
        """
        pass
    ...
    def test_create_multimaster_cluster_3_nodes(self, create_environment, install_postgres):
