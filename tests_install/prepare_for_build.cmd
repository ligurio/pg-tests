...
powershell -Command "((new-object net.webclient).DownloadFile('http://dist.l.postgrespro.ru/resources/windows/msys2-base-x86_64-20210725.tar.xz', '%TEMP%\msys.tar.xz'))"
